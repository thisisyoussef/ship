# UI Prompt Brief Template

Use this template when UI scope exists and the agent needs an explicit frontend brief before implementation.

The goal is to turn vague design intent into a reusable prompt contract.
