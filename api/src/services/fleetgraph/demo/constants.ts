...
export const FLEETGRAPH_DEMO_STORY_FINDING_SUMMARY = 'This story lane starts with a slipped week, then keeps the same sprint ready for a Review-tab guided overlay and a separate FAB follow-up.'
