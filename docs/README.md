...
- `docs/guides/agent-design-workflow.md`: design-heavy workflow for inspiration, Paper/Pencil canvas work, visual evaluation, and Codex/Claude implementation
- `docs/guides/design-visual-evaluation.md`: screenshot-driven critique loop for design-heavy stories when browser-based visual debugging helps
- `.claude/CLAUDE.md`: Ship-specific command appendix and operational notes

## FleetGraph Assignment

- `docs/assignments/fleetgraph/FleetGraph_PRD.pdf`: source PRD checked into the repo
- `docs/assignments/fleetgraph/README.md`: distilled brief, hard constraints, and start checklist
