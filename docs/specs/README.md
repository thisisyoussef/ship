...
2. Open `ship/SHIP-CURRENT-PRODUCT-SPEC/README.md`.
3. Use `ship/SHIP-CURRENT-PRODUCT-SPEC/developer-build-queue.md` for implementation order.
4. Use `ship/SHIP-CURRENT-PRODUCT-SPEC/acceptance-and-rebuild-checklist.md` as the final acceptance gate.
