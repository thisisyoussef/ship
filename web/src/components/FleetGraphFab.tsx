        ...
        <div className="fixed bottom-20 right-6 z-50 w-96 max-h-[70vh] bg-white rounded-xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          ...
          <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-gray-900">FleetGraph analysis</span>
              <span className="text-xs text-gray-500 ml-auto">
                {documentType}: {documentTitle}
              </span>
            </div>
            <p className="mt-3 text-xs text-gray-500">
              Ask FleetGraph to review this page and follow up in the same analysis thread.
            </p>
          </div>
